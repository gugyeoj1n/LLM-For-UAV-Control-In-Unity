...
public class SatelliteController : MonoBehaviour
{
    ...
    public RunYOLO yolo;
    public AutomaticSatelliteTrackingLogger trackingLogger;
    ...
    void Start()
    {
        ...
        trackingLogger = FindObjectOfType<AutomaticSatelliteTrackingLogger>();
        if (trackingLogger == null)
        {
            Debug.LogWarning("AutomaticSatelliteTrackingLogger를 찾을 수 없습니다. 자동 요약 기능이 비활성화됩니다.");
        }
    }
    ...
    public void StartTracking()
    {
        ...
        {
            Debug.Log($"[SatelliteController] 추적 시작: 대상과의 거리 = {Vector3.Distance(transform.position, trackingTarget.position)}m, 설정된 추적 거리 = {trackingDistance}m");
    ...
    public void OnCommand(SatelliteCommand command)
    {
        ...
        {
            case SatelliteCommand.SatelliteAction.Move:
                isHovering = false;
                isReturning = false;
                isReconnaissance = false;
                isMoving = true;
            ...
            case SatelliteCommand.SatelliteAction.Hover:
                isMoving = false;
                isReturning = false;
                isReconnaissance = false;
                isHovering = true;
            ...
            case SatelliteCommand.SatelliteAction.Altitude:
                isHovering = false;
            ...
            case SatelliteCommand.SatelliteAction.Rotate:
                isHovering = false;
                isRotating = true;
                yolo.enabled = false;
            ...
            case SatelliteCommand.SatelliteAction.Return:
                isMoving = false;
                isHovering = false;
                isReconnaissance = false;
                isReturning = true;
            ...
            case SatelliteCommand.SatelliteAction.Reconnaissance:
                isMoving = false;
                isHovering = false;
                isReturning = false;
            ...
            case SatelliteCommand.SatelliteAction.Tracking:
